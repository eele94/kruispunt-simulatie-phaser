...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(/*! C:\Users\your user name\Desktop\simphaser\src\main.js */298);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _game = __webpack_require__(/*! ./game */ 305);
	...
	var Game = function (_Phaser$Game) {
	  ...
	  */
		function Game() {
			...
			_this.state.add('Simulation', _game2.default, false);
	
			_this.state.start('Simulation');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vehicleController = __webpack_require__(/*! ./vehicleController */ 306);
	...
	var GameState = function (_Phaser$State) {
	   ...
	   */
			...
			value: function create() {
				...
				this.vehicleController = new _vehicleController2.default(this.game, this.game.world, 'vehicleController');
	
				this.lightController = new _lightController2.default(this.game, this.game.world, 'lightController', this.api);
	   ...
	   */
			...
			value: function render() {
				if (true) {
					var vehicles = this.vehicleController.children;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vehicle = __webpack_require__(/*! ./vehicles/vehicle */ 307);
	 ...
	 */
	var VehicleController = function (_Phaser$Group) {
		_inherits(VehicleController, _Phaser$Group);
	  ...
	  */
		function VehicleController(game, parent, name) {
			_classCallCheck(this, VehicleController);
	
			var _this = _possibleConstructorReturn(this, (VehicleController.__proto__ || Object.getPrototypeOf(VehicleController)).call(this, game, parent, name));
	
			_this.game = game;
			_this.initDebugKeys();
			_this.generateVehicles();
			return _this;
		}
	  ...
	  */
		...
		_createClass(VehicleController, [{
			key: 'update',
			value: function update() {
				this.children.forEach(function (x) {
					if (x instanceof _vehicle2.default) {
						x.update();
					}
				});
	   ...
	   */
			...
			key: 'generateVehicles',
			value: function generateVehicles() {
				this.generateTrains();
				this.generateCars();
				this.generateBusses();
	   ...
	   */
			...
			key: 'generateTrains',
			value: function generateTrains() {
				var _this2 = this;
	
				var time = this.game.rnd.integerInRange(25000, 35000);
				setTimeout(function () {
					_this2.addTrain();
					_this2.generateTrains();
				}, time);
			}
	   ...
	   */
			...
			value: function generateCars() {
				...
				var time = this.game.rnd.integerInRange(2500, 3500);
				setTimeout(function () {
					_this3.addCar();
					_this3.generateCars();
				}, time);
	   ...
	   */
			...
			key: 'generateBusses',
			value: function generateBusses() {
				var _this4 = this;
	
				var time = this.game.rnd.integerInRange(10000, 20000);
				setTimeout(function () {
					_this4.addBus();
					_this4.generateBusses();
				}, time);
			}
	   ...
	   */
			...
			key: 'generateWalkers',
			value: function generateWalkers() {
				var _this5 = this;
	
				var time = this.game.rnd.integerInRange(4000, 10000);
				setTimeout(function () {
					_this5.addWalker();
					_this5.generateWalkers();
				}, time);
			}
	   ...
	   */
			...
			key: 'generateCyclists',
			value: function generateCyclists() {
				var _this6 = this;
	
				var time = this.game.rnd.integerInRange(4000, 10000);
				setTimeout(function () {
					_this6.addCyclist();
					_this6.generateCyclists();
				}, time);
			}
	   ...
	   */
			...
			value: function addCar() {
				...
				var car = new _car2.default(this.game, light);
	   ...
	   */
			...
			value: function addTrain() {
				...
				var light = this.game.world.getByName('lightController').getByName(random);
				var train = new _train2.default(this.game, light);
	   ...
	   */
			...
			value: function addWalker() {
				...
				var random = startNodes[this.game.rnd.integerInRange(0, startNodes.length - 1)];
				var light = this.game.world.getByName('lightController').getByName(random);
				var walker = new _walker2.default(this.game, light);
	   ...
	   */
			...
			value: function addCyclist() {
				...
				var random = startNodes[this.game.rnd.integerInRange(0, startNodes.length - 1)];
				var light = this.game.world.getByName('lightController').getByName(random);
				var cyclist = new _cyclist2.default(this.game, light);
	   ...
	   */
			...
			key: 'initDebugKeys',
			value: function initDebugKeys() {
				var key1 = this.game.input.keyboard.addKey(_phaser2.default.Keyboard.ONE);
				key1.onDown.add(this.addCar, this);
				var key2 = this.game.input.keyboard.addKey(_phaser2.default.Keyboard.TWO);
				key2.onDown.add(this.addTrain, this);
				var key3 = this.game.input.keyboard.addKey(_phaser2.default.Keyboard.THREE);
				key3.onDown.add(this.addBus, this);
				var key4 = this.game.input.keyboard.addKey(_phaser2.default.Keyboard.FOUR);
				key4.onDown.add(this.addWalker, this);
				var key5 = this.game.input.keyboard.addKey(_phaser2.default.Keyboard.FIVE);
				key5.onDown.add(this.addCyclist, this);
				var key6 = this.game.input.keyboard.addKey(_phaser2.default.Keyboard.SPACEBAR);
	   ...
	   */
			...
			key: 'showRoutePoints',
			value: function showRoutePoints(lightId) {
				var _this7 = this;
	
				setTimeout(function () {
					var points = _this7.game.world.getByName('lightController').getByName(lightId).node.points;
	
					points.forEach(function (p) {
						var graphics = _this7.game.add.graphics(p.x, p.y);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var Vehicle = function (_Phaser$Sprite) {
		_inherits(Vehicle, _Phaser$Sprite);
	  ...
	  * @memberOf Vehicle
	  */
		function Vehicle(game, asset, light, speed) {
			_classCallCheck(this, Vehicle);
	
			var _this = _possibleConstructorReturn(this, (Vehicle.__proto__ || Object.getPrototypeOf(Vehicle)).call(this, game, 0, 0, asset));
	
			_this.anchor.set(0.5);
			_this.light = light;
	
			var pointsX = light.node.points.map(function (point) {
				return point.x;
			});
	
			var pointsY = light.node.points.map(function (point) {
				return point.y;
			});
			...
			_this.lightStopLocations = light.node.points.filter(function (point) {
				if (point.light) {
					return point;
				}
			});
			_this.lightIndex = 0;
			_this.lightId = -1;
			_this.lightCount = _this.light.count;
	
			// should be overridden in extended class
			_this.VEHICLE_DISTANCE = 0;
			_this.speed = speed;
	
			_this.rotationOffset = light.sprite.rotation;
			_this.pathIndex = 0;
			_this.path = [];
			_this.plot();
	  ...
	  */
		...
		_createClass(Vehicle, [{
			...
			value: function plot() {
				...
				for (var i = 0; i <= 1; i += x) {
					var px = _phaser2.default.Math.bezierInterpolation(this.points.x, i);
					var py = _phaser2.default.Math.bezierInterpolation(this.points.y, i);
					...
					if (ix > 0) {
						switch (this.light.node.dir) {
							case 'u':
								node.angle -= _phaser2.default.Math.angleBetweenPointsY(node, this.path[ix - 1]);
								break;
							case 'r':
								node.angle = _phaser2.default.Math.angleBetweenPoints(this.path[ix - 1], node);
								break;
							case 'd':
								node.angle = _phaser2.default.Math.angleBetweenPoints(this.path[ix - 1], node) - Math.PI / 2;
								break;
							case 'l':
								node.angle = _phaser2.default.Math.angleBetweenPoints(node, this.path[ix - 1]);
								break;
						}
					}
	   ...
	   */
			...
			key: 'isLightGreen',
			value: function isLightGreen(id) {
				var color = this.getLightById(id).color;
				return color === _lightState2.default.GREEN;
			}
	   ...
	   */
			...
			key: 'increaseLightCount',
			value: function increaseLightCount(id) {
	   ...
	   */
			...
			key: 'decreaseLightCount',
			value: function decreaseLightCount(id) {
				this.getLightById(id).count--;
				this.lightIndex++;
			}
	   ...
	   */
			...
			key: 'atPosition',
			value: function atPosition(p1, p2) {
				var dx = p1.x - p2.x;
				var dy = p1.y - p2.y;
	   ...
	   */
			...
			key: 'calculateStopPosition',
			value: function calculateStopPosition(lightId) {
				var distance = this.VEHICLE_DISTANCE * this.lightCount;
	
				var point = Object.assign({}, this.lightStopLocations[this.lightIndex]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vehicle = __webpack_require__(/*! ./vehicle */ 307);
	...
	var Car = function (_Vehicle) {
	  ...
	  * @memberOf Car
	  */
		function Car(game, light) {
			_classCallCheck(this, Car);
	
			var textures = ['car_black_1', 'car_green_1', 'car_yellow_1', 'car_orange_1', 'car_blue_1', 'car_black_2', 'car_green_2', 'car_yellow_2', 'car_orange_2', 'car_blue_2', 'car_black_3', 'car_green_3', 'car_yellow_3', 'car_orange_3', 'car_blue_3'];
			var randomTexture = textures[game.rnd.integerInRange(0, textures.length - 1)];
	
			var SPEED = 8;
	
			var _this = _possibleConstructorReturn(this, (Car.__proto__ || Object.getPrototypeOf(Car)).call(this, game, randomTexture, light, SPEED));
	
			_this.scale.set(0.6);
			_this.VEHICLE_DISTANCE = 90;
			return _this;
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Walker = function (_Vehicle) {
		_inherits(Walker, _Vehicle);
	  ...
	  * @memberOf Walker
	  */
		function Walker(game, light) {
			_classCallCheck(this, Walker);
	
			var textures = ['p1', 'p2', 'p3', 'p4', 'p5', 'p6', 'p7', 'p8', 'p9', 'p10', 'p11', 'p12'];
			var randomTexture = textures[game.rnd.integerInRange(0, textures.length - 1)];
			var SPEED = 2;
	
			var _this = _possibleConstructorReturn(this, (Walker.__proto__ || Object.getPrototypeOf(Walker)).call(this, game, randomTexture, light, SPEED));
	
			_this.scale.set(0.6);
			_this.VEHICLE_DISTANCE = 25;
			return _this;
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Train = function (_Vehicle) {
		_inherits(Train, _Vehicle);
	  ...
	  * @memberOf Train
	  */
		function Train(game, light) {
			_classCallCheck(this, Train);
	
			var SPEED = 10;
	
			var _this = _possibleConstructorReturn(this, (Train.__proto__ || Object.getPrototypeOf(Train)).call(this, game, 'train', light, SPEED));
	
			_this.scale.set(0.4);
	
			if (_this.light.node.dir === 'l') {
				_this.scale.x = -0.4;
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Bus = function (_Vehicle) {
	  ...
	  * @memberOf Bus
	  */
		function Bus(game, light) {
			_classCallCheck(this, Bus);
	
			var SPEED = 8;
	
			var _this = _possibleConstructorReturn(this, (Bus.__proto__ || Object.getPrototypeOf(Bus)).call(this, game, 'bus', light, SPEED));
	
			_this.scale.set(0.6);
			_this.VEHICLE_DISTANCE = 220;
			return _this;
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Cyclist = function (_Vehicle) {
		_inherits(Cyclist, _Vehicle);
	  ...
	  * @memberOf Cyclist
	  */
		function Cyclist(game, light) {
			_classCallCheck(this, Cyclist);
	
			var SPEED = 4;
	
			var _this = _possibleConstructorReturn(this, (Cyclist.__proto__ || Object.getPrototypeOf(Cyclist)).call(this, game, 'cyclist', light, SPEED));
	
			_this.scale.set(0.6);
			_this.VEHICLE_DISTANCE = 60;
			return _this;
		}
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @extends {Phaser.Group}
	 */
	var LightController = function (_Phaser$Group) {
		_inherits(LightController, _Phaser$Group);
	  ...
	  */
		function LightController(game, parent, name, api) {
			_classCallCheck(this, LightController);
	
			var _this = _possibleConstructorReturn(this, (LightController.__proto__ || Object.getPrototypeOf(LightController)).call(this, game, parent, name));
	
			_nodes2.default.forEach(function (x) {
				var light = new _light2.default(_this.game, _this.game.world, x.id, x, api);
				_this.add(light);
			});
			return _this;
		}
	  ...
	  */
		...
		_createClass(LightController, [{
			key: 'setLightState',
			value: function setLightState(state) {
				this.children.forEach(function (x) {
	   ...
	   */
			...
			value: function getLightState() {
				return {
					state: this.children.map(function (x) {
						return {
							trafficLight: x.id,
							count: x.count
						};
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @extends {Phaser.Group}
	 */
	var Light = function (_Phaser$Group) {
		_inherits(Light, _Phaser$Group);
	  ...
	  * @memberOf Light
	  */
		function Light(game, parent, name, node) {
			_classCallCheck(this, Light);
	
			var _this = _possibleConstructorReturn(this, (Light.__proto__ || Object.getPrototypeOf(Light)).call(this, game, parent, name));
	
			_this.id = node.id;
			_this._color = null;
			_this._count = 0;
			_this._node = node;
			_this.sprite = new _phaser2.default.Sprite(game, node.position.x, node.position.y, 'light', 0);
			_this.sprite.width = 23;
			_this.sprite.height = 63;
			_this.sprite.anchor.set(0.5);
			_this.add(_this.sprite);
			_this.api = new _api2.default();
			_this.color = node.color;
			...
			switch (node.dir) {
				case 'u':
					...
					break;
				case 'r':
					_this.sprite.rotation = Math.PI / 2;
					break;
				case 'd':
			...
			_this.text = game.add.text(_this.sprite.x - 10, _this.sprite.y - 45, _this.id + ':' + _this.count, {
				font: '15px Arial',
				fill: '#00000',
				align: 'center'
			});
	  ...
	  */
	   ...
	   */
			...
			set: function set(val) {
				this._color = val;
				switch (val) {
					case _lightState2.default.GREEN:
						this.sprite.frame = 2;
						break;
					case _lightState2.default.ORANGE:
						this.sprite.frame = 1;
						break;
					case _lightState2.default.YELLOW:
						this.sprite.frame = 1;
						break;
					case _lightState2.default.RED:
						this.sprite.frame = 0;
						break;
					default:
						this.sprite.frame = 0;
...
/***/ function(module, exports) {
	...
	var API = function () {
	  ...
	  */
		...
		_createClass(API, [{
			key: 'setup',
			value: function setup(wsAddress, lightController) {
	   ...
	   */
			...
			key: 'connect',
			value: function connect(wsAddress) {
				var _this = this;
				...
				if (wsAddress) {
					...
					this.ws.onopen = function () {
						...
						_this.sendTrafficState();
					};
	
					this.ws.onmessage = function (event) {
						var parsed = JSON.parse(event.data);
						_this.lightController.setLightState(parsed.state);
					};
	
					this.ws.onclose = function () {
						console.log('disconnected');
						setTimeout(function () {
							_this.connect(_this.wsAddress);
						}, 2000);
					};
				}
			}
	   ...
	   */
			...
			key: 'sendTrafficState',
			value: function sendTrafficState() {
